...
%- [list]% provide enhanced list environments for thm and coding
...
\setlength{\intextsep}{10pt plus 2pt minus 2pt}% user defined commands
...
% 定义算法中使用的函数名命令
\newcommand{\scss}[1]{\text{\ttfamily #1}}
